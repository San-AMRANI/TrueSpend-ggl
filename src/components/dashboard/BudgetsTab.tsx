...
export const BudgetsTab: React.FC<BudgetsTabProps> = ({ budgets, transactions, onSaveBudget, onCopyPrevious }) => {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col justify-between gap-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 shadow-sm sm:flex-row sm:items-center">
      <div><h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Monthly Category Budgets</h2><p className="text-sm text-gray-500 dark:text-gray-400">Budgets and spending are tied to the transaction’s selected date.</p></div>
