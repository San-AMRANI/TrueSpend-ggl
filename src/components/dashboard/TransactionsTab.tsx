...
import { ArrowDownRight, ArrowUpRight, Banknote, Edit2, Filter, Landmark, Plus, RefreshCw, Search, Trash2, X, Tag } from 'lucide-react';
...
export const TransactionsTab: React.FC<TransactionsTabProps> = ({ transactions, wallets, contexts = [], handleDeleteTx, fetchData, selectedTransactionId, onSelectionHandled }) => {
