...
import { CategoryBudget, KPI, Transaction, Debt, Payroll, UserSettings, Wallet, FinancialContext, Goal, Subscription, DetectedSubscription, ImpulseItem, ImpulseStats, FireProfile } from '../../types';
