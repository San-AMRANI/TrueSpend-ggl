...
const settingsBlock = `      {activeTab === 'settings' && (
        <Card>
          <CardHeader>
              ...
              <div className="rounded-lg border border-blue-100 bg-blue-50 p-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button 
                    ...
                    onClick={() => {
                       // Just switch to overview and focus transaction form
...
code = code.replace(/\{activeTab === 'settings' && \([\s\S]*?\}\)/, settingsBlock);

fs.writeFileSync('src/components/Dashboard.tsx', code);
console.log('Patched Settings in Dashboard.tsx');
